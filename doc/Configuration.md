...
base Qubes OS build you probably want to enable 'builder-yum' plugin.
...
BUILDER_PLUGINS_fc20 = builder-yum
...
writting this, the feature is supported by `builder-yum` and
